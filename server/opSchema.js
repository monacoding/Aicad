...
const variants = [
  ...
  variant("add_symbol", ["symbol", "at"], {
    ...
    scale: { type: "number" },
    rotation: { type: "number", description: "degrees" },
    tag: { type: "string", description: "label e.g. FT-101, P-201" },
    layer: { type: "string" },
    color: { type: "string" },
  }),
  variant("add_pipe", ["points"], { points: { type: "array", items: XY }, layer: { type: "string" } }),
  variant("add_signal", ["a", "b"], { a: XY, b: XY, layer: { type: "string" } }),
